    ...
    <div className='card-border w-[360px] max-sm:w-full min-h-96'>
        <div className='card-interview'>
            <div>
                ...
                <Image src={getRandomInterviewCover()} alt='image-cover' width={90} height={90} className='rounded-full object-fit size-[90px]'/>
                ...
                <p className='line-clamp-2 mt-5'>
                    ...
                    || "you have't taken interview yet.Take it now to improve your skills"}
                </p>
            </div>
